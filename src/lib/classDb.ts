...
export const DEFAULT_CLASS_STUDENTS: ClassStudentRecord[] = [
  {
    id: 'std-rabee',
    fullName: 'ربيع إسماعيل محمد كامل عيسى',
    fullNameEn: 'Rabee Ismail Issa',
    grade: 'الصف الثالث الابتدائي — فصل د. إسماعيل عيسى',
    nationalId: '1098765432',
    dateOfBirth: '2016-04-15',
    parentName: 'د. إسماعيل عيسى (ولي الأمر)',
    parentPhone: '966501234567',
    photoUrl: '',
    notes: 'طالب متميز ومتفوق في مهارات القراءة والحساب والذكاء الإدراكي',
    assignedProgram: 'reading',
    assignedPrograms: ['reading', 'math', 'learning-difficulties'],
  ...
  },
  {
    ...
    fullNameEn: 'Omar Khalid Al-Saeed',
    grade: 'الصف الثالث الابتدائي — فصل د. إسماعيل عيسى',
    nationalId: '1087654321',
    dateOfBirth: '2016-06-20',
    parentName: 'أ. خالد السعيد',
    parentPhone: '966502345678',
    photoUrl: '',
    notes: 'مشاركة صفية وتفاعل مستمر في الأنشطة المدرسية',
    assignedProgram: 'math',
    assignedPrograms: ['math', 'reading'],
    assignedBy: 'د. إسماعيل عيسى',
    createdAt: '2026-08-01T08:00:00.000Z',
    updatedAt: '2026-08-01T08:00:00.000Z',
  },
  {
    id: 'std-abdullah',
    fullName: 'عبدالله يوسف المنصور',
    fullNameEn: 'Abdullah Yousef Al-Mansour',
    grade: 'الصف الثالث الابتدائي — فصل د. إسماعيل عيسى',
    nationalId: '1076543210',
    dateOfBirth: '2016-09-10',
    parentName: 'أ. يوسف المنصور',
    parentPhone: '966503456789',
    photoUrl: '',
    notes: 'تقدم ممتاز في مهارات الفهم القرائي',
    assignedProgram: 'reading',
  ...
  {
    id: 'std-mohammed',
    fullName: 'محمد أحمد الغامدي',
    fullNameEn: 'Mohammed Ahmed Al-Ghamdi',
    grade: 'الصف الثالث الابتدائي — فصل د. إسماعيل عيسى',
    nationalId: '1065432109',
    dateOfBirth: '2016-03-05',
    parentName: 'أ. أحمد الغامدي',
    parentPhone: '966504567890',
    photoUrl: '',
    notes: 'التزام تام بالواجبات والكويزات الصفية',
    assignedProgram: 'math',
    assignedPrograms: ['math'],
    assignedBy: 'د. إسماعيل عيسى',
    createdAt: '2026-08-01T08:00:00.000Z',
    updatedAt: '2026-08-01T08:00:00.000Z',
  },
  {
    id: 'std-salman',
    fullName: 'سلمان فهد الحربي',
    fullNameEn: 'Salman Fahad Al-Harbi',
    grade: 'الصف الثالث الابتدائي — فصل د. إسماعيل عيسى',
    nationalId: '1054321098',
    dateOfBirth: '2016-11-25',
    parentName: 'أ. فهد الحربي',
    parentPhone: '966505678901',
    photoUrl: '',
    notes: 'شغف وحماس عالي في الألعاب التعليمية التفاعلية',
    assignedProgram: 'reading',
  ...
  {
    id: 'std-faisal',
    fullName: 'فيصل سعد القحطاني',
    fullNameEn: 'Faisal Saad Al-Qahtani',
    grade: 'الصف الثالث الابتدائي — فصل د. إسماعيل عيسى',
    nationalId: '1043210987',
    dateOfBirth: '2016-07-18',
    parentName: 'أ. سعد القحطاني',
    parentPhone: '966506789012',
    photoUrl: '',
  ...
  {
    id: 'std-sara',
    fullName: 'سارة تركي الدوسري',
    fullNameEn: 'Sara Turki Al-Dossari',
    grade: 'الصف الثالث الابتدائي — فصل د. إسماعيل عيسى',
    nationalId: '1032109876',
    dateOfBirth: '2016-02-12',
    parentName: 'أ. تركي الدوسري',
    parentPhone: '966507890123',
    photoUrl: '',
    notes: 'طالبة مبدعة في التعبير اللغوي والرسم',
    assignedProgram: 'reading',
    assignedPrograms: ['reading', 'learning-difficulties'],
    assignedBy: 'د. إسماعيل عيسى',
    createdAt: '2026-08-01T08:00:00.000Z',
    updatedAt: '2026-08-01T08:00:00.000Z',
  }
