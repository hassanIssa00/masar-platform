...
export const curriculaList: CurriculumSubject[] = [
  ...
  },
  {
    ...
    promise: 'عرض تفاعلي لجزء عمّ كامل بخط واضح وتصفح فوري فائق السرعة. مخصص للقراءة والحفظ والمتابعة — دون إمكانية الكتابة على الصفحات حفاظاً على حرمة المصحف الشريف.',
    units: [
