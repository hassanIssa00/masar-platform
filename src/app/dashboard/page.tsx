          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-900 via-teal-900 to-slate-900 p-6 md:p-8 text-white shadow-xl border border-teal-800/40">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex items-center gap-5">
                <div className="relative w-20 h-20 rounded-2xl overflow-hidden border-2 border-amber-400/80 shadow-lg shrink-0 bg-[#f1f0f4]">
                  <img
                    src="/dr-ismail.jpg"
                    alt="د. إسماعيل عيسى"
                    className="w-full h-full object-contain bg-[#f1f0f4]"
                  />
                </div>
                <div>
