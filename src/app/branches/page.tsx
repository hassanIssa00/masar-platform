      ...
      <div className="flex">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full space-y-6">
          ...
          <FeatureGuideBanner
            ...
            description="لوحة تشغيل مركزي للتحكم بجميع الفروع الإقليمية والمحلية للمركز، توزيع الأخصائيين، ومتابعة الطلاب في كل موقع."
            benefits={[
              'تُمكّن المؤسسة من التوسع وفتح فروع جديدة مع توحيد المعايير والجودة التأهيلية والتعليمية.',
            ...
            modernShift="التوسع في المراكز التأهيلية والتعليمية الحديثة يتطلب بنية تشغيل سحابية موحدة (Multi-Tenant/Multi-Branch Architecture) تضمن الربط اللحظي بين الفروع دون تشتت الإدارة."
          />
