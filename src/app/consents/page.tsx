      ...
      <div className="flex">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full space-y-6">
          ...
          <FeatureGuideBanner
            ...
            description="منظومة إلكترونية موثقة لجمع وتوثيق موافقات أولياء الأمور على البرامج التأهيلية والتصوير وتداول البيانات التأهيلية والتربوية بشكل قانوني آمن."
            benefits={[
            ...
            modernShift="الأمان وحماية خصوصية بيانات الطفل التأهيلية والنفسية هو حجر الزاوية في المعايير العالمية الحديثة (HIPAA & GDPR)، ونقل المعاملات من الورق إلى التوقيع الرقمي المعتمد يعزز الثقة والموثوقية."
          />
